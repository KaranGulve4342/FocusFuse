...
export default function Projects() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div className="mx-auto mb-8 max-w-screen-md lg:mb-16">
          ...
          <p className="font-light text-gray-500 sm:text-lg dark:text-black-400"><strong className='font-bold'>We're</strong> just <strong >adventurers</strong> attempting to make waves in a world where everyone is <strong className='font-bold'>influential</strong> in some capacity.
We launched this project with the goal of <strong className='font-bold'>venturing</strong> into the unexplored territories in a student's life, <strong className='font-bold'>inspiring</strong> others, and finding inspiration in their tales for ourselves. 
We hope that everyone who reads us will benefit from this <strong className='font-bold'>newsletter.</strong>.</p>
      </div> 
...
{/*           
<div className="text-center text-gray-500 dark:text-gray-400">
<Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Helene Avatar"/>
<h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
...
<li>
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Jese Leos</a>
              </h3>
              <p>SEO & Marketing</p>
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png" alt="Joseph Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/sofia-mcguire.png" alt="Sofia Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Lana Byrd</a>
              </h3>
              <p>Web Designer</p>
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/thomas-lean.png" alt="Leslie Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="Michael Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
               <Image width="100" height="100"  className="mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/neil-sims.png" alt="Neil Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Neil Sims</a>
              </h3>
